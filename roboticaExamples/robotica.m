...
PrintInputData[]:=
	...
	aColumn=ColumnForm[
	   Prepend[Table[FortranForm[a[j]],{j,dof}],Style["r",Bold]]
	  ];
	alphaColumn=ColumnForm[ 
		Prepend[Table[FortranForm[alpha[j]],{j,dof}],Style["\[Alpha]",Bold]]
	      ];
	dColumn=ColumnForm[
	   Prepend[Table[FortranForm[d[j]],{j,dof}],Style["d",Bold]]
	  ];
	thetaColumn=ColumnForm[ 
		Prepend[Table[FortranForm[theta[j]],{j,dof}],Style["\[Theta]",Bold]]
	      ];
