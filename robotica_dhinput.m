...
createdh::usage = "create"
createdh2::usage " Create"
...
dhinput[x2_]:=
Do[x3 = Dimensions[x2];
If[NumberQ[x2] && x2>0, dof = x2; createdh[],If[ Length[x2]==5, dof= x3[[2]]; DH = x2; createdh2[],dof= Input["How many joints (DOF) does your robot have?"]; 
createdh[]]];
$dhinput$ = "YES";
];
